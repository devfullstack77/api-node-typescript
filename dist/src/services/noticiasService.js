...
const noticiasRepository_1 = require("../repository/noticiasRepository");
class NoticiasService {
    ...
    get(_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            result.Data = yield noticiasRepository_1.NoticiasRepository.findById(_id);
            return result.Data;
        });
    }
    /**
    ...
    getAll(page, qtd) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            result.Page = page;
            result.Qtd = qtd;
            result.Total = yield noticiasRepository_1.NoticiasRepository.count({});
            result.Data = yield noticiasRepository_1.NoticiasRepository.find({})
                .skip(page * qtd - qtd)
                .limit(qtd);
            return result;
        });
